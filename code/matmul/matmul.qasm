...
mul24 rb20, r1, r2  #A_base_addr = i * bytes_per_row
...
:inner_loop
    ...
    #For VPM write, use VPM Row at index QPU_NUM * 16 + k (For h32 VPM setup, VPM Y is bits 0:5 p. 57)
    shl r3, ra5, 4
    add r3, r3, ra12
    add vw_setup, r2, r3
    ...
    mov r2, vdw_setup_0(1, 16, dma_h32(0, 0)) #DMA write OF 16 item
    shl r1, ra5, 11                                 #DMA WRITE OFFSET
    add vw_setup, r1, r2


    mov r2, rb20            #C_base_addr
    shl r3, ra11, 2         #row_pointer = j_base * (4 bytes)
