...
mov r1, ra5
mov ra10, r1    #i = QPU_NUM
shl ra6, r1, 2  # VPM Offset = i * 4
...
:inner_loop
    ...
    mov r2, vdr_setup_0(0, 1, 16, vdr_h32(1, 0, 0)) #DMA READ OF 1 item
    ...
    mov vr_setup, vdr_setup_1(64)   #STRIDED
    mov r2, vdr_setup_0(0, 1, 16, vdr_h32(1, 0, 0)) #DMA READ OF 1 item
    shl r1, ra5, 8                                  #DMA READ OFFSET
    shl r3, ra12, 4                                  #ROW K
    add r1, r1, r3
    ...
    mov r2, vdw_setup_0(0, 1, 16, dma_h32(1, 0, 0)) #DMA READ OF 1 item
    shl r1, ra5, 10                                 #DMA WRITE OFFSET
    add vr_setup, r1, r2


    mov r2, rb10            #C_base_addr
