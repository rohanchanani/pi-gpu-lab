...
**Scope:** finish the scheduled-VC4 artifact/runtime backend so later `gpu -> ssavc4 -> vc4` lowering has a stable CUDA-like target  
...
12. The backend target is stable enough for M3 `ssavc4` lowering and later `gpu -> ssavc4 -> vc4` lowering.
