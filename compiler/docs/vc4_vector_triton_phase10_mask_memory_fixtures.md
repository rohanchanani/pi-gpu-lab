...
## Phase 10.5 Value Hardware Isolation

The value-level Phase 10 mask/memory classifier has been proven on real VC4
hardware using targeted isolation fixtures. This does not reopen Triton
readiness; controlled TTIR support remains staged for later phases.
