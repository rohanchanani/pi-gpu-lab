...
// RUN: %vc4_triton_opt "%vc4_repo_root/examples/triton/phase15_sfu_softmax/generated/ttir_sfu_recip_div_f32_b16.ttir.mlir" --convert-triton-to-vc4-value -o - | FileCheck %s --check-prefix=VALUE --implicit-check-not='tt.' --implicit-check-not='ttg.' --implicit-check-not='vc4kernel.' --implicit-check-not='ssavc4.' --implicit-check-not='builtin.unrealized_conversion_cast'
// RUN: %vc4_triton_opt "%vc4_repo_root/examples/triton/phase15_sfu_softmax/generated/ttir_sfu_recip_div_f32_b16.ttir.mlir" --convert-triton-to-vc4-value -o %t.value.mlir
// RUN: %vc4_opt_triton %t.value.mlir --vc4-verify-value-surface --convert-scf-to-cf --convert-vc4-value-to-vc4kernel --verify-vc4kernel -o - | FileCheck %s --check-prefix=VC4KERNEL --implicit-check-not='arith.divf'
...
// VALUE-LABEL: func.func @ttir_sfu_recip_div_f32_b16
...
// VC4KERNEL-LABEL: vc4kernel.kernel @ttir_sfu_recip_div_f32_b16
