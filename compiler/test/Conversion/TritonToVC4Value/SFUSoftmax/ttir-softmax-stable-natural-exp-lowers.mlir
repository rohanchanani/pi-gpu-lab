...
// RUN: %vc4_triton_opt "%vc4_repo_root/examples/triton/phase15_sfu_softmax/generated/ttir_softmax_stable_f32_b16.ttir.mlir" --convert-triton-to-vc4-value -o - | FileCheck %s --check-prefix=VALUE --implicit-check-not='tt.' --implicit-check-not='ttg.' --implicit-check-not='vc4kernel.' --implicit-check-not='ssavc4.'
// RUN: %vc4_triton_opt "%vc4_repo_root/examples/triton/phase15_sfu_softmax/generated/ttir_softmax_stable_f32_b16.ttir.mlir" --convert-triton-to-vc4-value -o %t.value.mlir
// RUN: %vc4_opt_triton %t.value.mlir --vc4-verify-value-surface --convert-scf-to-cf --convert-vc4-value-to-vc4kernel --verify-vc4kernel -o - | FileCheck %s --check-prefix=VC4KERNEL --implicit-check-not='math.exp'
...
// VALUE-LABEL: func.func @ttir_softmax_stable_f32_b16
...
// VC4KERNEL-LABEL: vc4kernel.kernel @ttir_softmax_stable_f32_b16
// VC4KERNEL: vc4kernel.fragment_reduce
// VC4KERNEL-SAME: kind = #vc4kernel.reduce<fmax>
// VC4KERNEL: vc4kernel.fragment_const
// VC4KERNEL-SAME: 1.44269502
