...
// CHECK-LABEL: vc4.func @pressure_no_spill_boundary_kernel
// CHECK-SAME: public_name = "pressure_no_spill_boundary"
// CHECK: value = 22 : i32
// CHECK: vc4.qpu.vpmvcd_addr
// CHECK-SAME: side = #vc4.vpmvcd_side<write>
// CHECK: sig = #vc4.qpu_signal<thrend>
ssavc4.module @pressure_no_spill_boundary {
  ssavc4.func @pressure_no_spill_boundary_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "pressure_no_spill_boundary",
      code_symbol = "pressure_no_spill_boundary_shader",
