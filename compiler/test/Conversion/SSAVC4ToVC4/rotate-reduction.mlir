...
ssavc4.module @rotate_reduction_lowering {
  ssavc4.func @kernel() attributes {
    ...
    "vc4.launch_abi" = {public_name = "rotate_reduction_lowering", code_symbol = "rotate_reduction_lowering_shader", tail_policy = "exact_multiple", uniform_words_per_qpu = 2 : i32, args = [], builtins = [{name = "qpu_id", kind = #vc4.builtin_kind<qpu_num>, materialization = "uniform_suffix", uniform_index = 0 : i32}, {name = "num_qpus", kind = #vc4.builtin_kind<num_qpus>, materialization = "uniform_suffix", uniform_index = 1 : i32}]},
