...
// CHECK: vc4.qpu.bundle
// CHECK: vc4.qpu.bundle
ssavc4.module @spill_branch_tail_independent {
  ssavc4.func @spill_branch_tail_independent_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "spill_branch_tail_independent",
      code_symbol = "spill_branch_tail_independent_shader",
