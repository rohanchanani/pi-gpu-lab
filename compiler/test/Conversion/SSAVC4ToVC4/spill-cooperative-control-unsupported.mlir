...
// CHECK: S4 spilling does not support spilling semaphore/control protocol values
ssavc4.module @spill_cooperative_control_unsupported {
  ssavc4.func @spill_cooperative_control_unsupported_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "spill_cooperative_control_unsupported",
      code_symbol = "spill_cooperative_control_unsupported_shader",
    ...
    %qpu_id = ssavc4.uniform.read 1 : i32
