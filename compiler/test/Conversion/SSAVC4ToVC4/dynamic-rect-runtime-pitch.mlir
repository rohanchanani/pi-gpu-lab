...
// CHECK-LABEL: vc4.func @dynamic_rect_runtime_pitch_active_cols_kernel
...
ssavc4.module @dynamic_rect_runtime_pitch {
  ...
  ssavc4.func @dynamic_rect_runtime_pitch_active_cols_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_rect_runtime_pitch_active_cols",
      code_symbol = "dynamic_rect_runtime_pitch_active_cols_shader",
      tail_policy = "exact_multiple",
      uniform_words_per_qpu = 4 : i32,
      args = [
        {name = "in", kind = "buffer", direction = "in", elem_type = "u32", uniform_index = 0 : i32},
    ...
    ssavc4.vdw.store_rect.dynamic %out, %row0, %rows, %active_cols, %pitch {
      max_rows = 1 : i32,
      max_cols = 16 : i32,
      elem_bytes = 4 : i32,
      orientation = #ssavc4.vpm_orientation<horizontal>,
  ...
  ssavc4.func @dynamic_rect_runtime_pitch_rows_cols_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_rect_runtime_pitch_rows_cols",
      code_symbol = "dynamic_rect_runtime_pitch_rows_cols_shader",
      tail_policy = "exact_multiple",
  ...
  ssavc4.func @dynamic_rect_runtime_stride_rows_cols_store_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_rect_runtime_stride_rows_cols_store",
      code_symbol = "dynamic_rect_runtime_stride_rows_cols_store_shader",
      tail_policy = "exact_multiple",
      uniform_words_per_qpu = 4 : i32,
      args = [
