// RUN: vc4-opt %vc4_repo_root/compiler/test/ValueSurface/value-surface-online-softmax-state-composite-valid.mlir --convert-scf-to-cf --vc4-verify-value-surface --convert-vc4-value-to-vc4kernel --verify-vc4kernel | FileCheck %s

// CHECK-LABEL: vc4kernel.kernel @online_softmax_state_composite
// CHECK: cf.br
