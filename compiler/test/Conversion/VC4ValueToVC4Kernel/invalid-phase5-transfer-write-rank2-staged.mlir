...
func.func @write_rank2(%out: memref<4x16xf32, #vc4value.global> {vc4value.arg_name = "out", vc4value.direction = "out"})
    attributes {vc4value.kernel, vc4value.grid_rank = 1 : i32} {
  %c0 = arith.constant 0 : index
  %value = arith.constant dense<1.000000e+00> : vector<16xf32>
  vector.transfer_write %value, %out[%c0, %c0] {in_bounds = [true]} : vector<16xf32>, memref<4x16xf32, #vc4value.global>
  return
}
