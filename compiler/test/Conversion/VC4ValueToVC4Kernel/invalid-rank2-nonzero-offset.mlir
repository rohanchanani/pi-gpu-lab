...
func.func @invalid_rank2_nonzero_offset(
    ...
    %in: memref<?x?xi32, strided<[?, 1], offset: 4>, #vc4value.global> {vc4value.arg_name = "in", vc4value.direction = "in", vc4value.shape_args = ["rows", "cols"], vc4value.stride_args = ["row_stride"]})
    attributes {vc4value.kernel, vc4value.grid_rank = 1 : i32} {
  return
}

// CHECK: public memref layout offset must be static 0
