...
// CHECK-LABEL: ssavc4.func @fragment_reduce_one_hot_f32
...
// CHECK-NOT: vc4kernel.
module {
  vc4kernel.kernel @fragment_reduce_one_hot_f32(%out : i32, %value : f32, %kk : i32) attributes {
    public_name = "fragment_reduce_one_hot_f32",
