...
module {
  vc4kernel.kernel @vpm_read_one_hot_reduce_broadcast(%out : i32, %kk : i32) attributes {
    ...
    vc4kernel.vpm_write_fragment %tile, %c0, %base, %full {orientation = #vc4kernel.vpm_orientation<horizontal>, width = #vc4kernel.vpm_width<w32>, subword = #vc4kernel.vpm_subword<none>, x = 0 : i32, stride = 1 : i32, memory_path = #vc4kernel.memory_path<vpm_qpu>, coherency = #vc4kernel.coherency<vpm_local>} : !vc4kernel.vpm_tile, i32, vector<16xf32>, !vc4kernel.pred<16>
    ...
    %sum = vc4kernel.fragment_reduce %read, %one_hot {kind = #vc4kernel.reduce<add>, fp_policy = #vc4kernel.fp_reduce_policy<finite_tree>} : vector<16xf32>, !vc4kernel.pred<16> -> vector<16xf32>
