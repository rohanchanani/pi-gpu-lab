...
module {
  vc4kernel.kernel @tail_store(%out : i32, %base_index : i32, %limit : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %byte_offsets, %value, %tail {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
  ...
  vc4kernel.kernel @empty_store(%out : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %byte_offsets, %value, %empty {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
