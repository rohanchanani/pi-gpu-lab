...
// CHECK-LABEL: ssavc4.func @fragment_broadcast_lane_composite
// CHECK-NOT: vc4kernel.fragment_broadcast_lane
...
// CHECK-NOT: vc4kernel.
module {
  vc4kernel.kernel @fragment_broadcast_lane_composite(%bits_in : i32, %f_in : i32, %out_i32 : i32, %out_f32_bits : i32, %lane_seed : i32) attributes {
    public_name = "fragment_broadcast_lane_composite",
    ...
    %f_payload = vc4kernel.tmu_load_fragment %f_in, %lane_bytes, %full, %safe_f32 {inactive_load = #vc4kernel.inactive_load<zero>, memory_path = #vc4kernel.memory_path<tmu_global_read>, coherency = #vc4kernel.coherency<readonly_tmu>} : i32, vector<16xi32>, !vc4kernel.pred<16>, i32 -> vector<16xf32>
