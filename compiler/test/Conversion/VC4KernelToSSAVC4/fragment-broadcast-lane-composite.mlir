...
// CHECK: ssavc4.alu.add {{.*}}vector<16xf32>
// CHECK-NOT: vc4kernel.
module {
  vc4kernel.kernel @fragment_broadcast_lane_composite(%bits_in : i32, %f_bits_in : i32, %finite_f32_in : i32, %out_i32 : i32, %out_f32_bits : i32, %out_finite_f32 : i32, %lane_seed : i32) attributes {
