...
module {
  vc4kernel.kernel @tmu_general_mask(%in : i32, %out : i32, %threshold : i32) attributes {
    ...
    %loaded = vc4kernel.tmu_load_fragment %in, %byte_offsets, %mask, %p7_safe0 {inactive_load = #vc4kernel.inactive_load<zero>, memory_path = #vc4kernel.memory_path<tmu_global_read>, coherency = #vc4kernel.coherency<readonly_tmu>} : i32, vector<16xi32>, !vc4kernel.pred<16>, i32 -> vector<16xi32>
