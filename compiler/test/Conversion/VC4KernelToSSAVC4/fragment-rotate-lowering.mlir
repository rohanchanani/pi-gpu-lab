...
module {
  vc4kernel.kernel @fragment_rotate(%out : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %byte_offsets, %r0, %full {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
