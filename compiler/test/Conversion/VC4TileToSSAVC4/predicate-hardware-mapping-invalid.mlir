...
vc4tile.kernel @predicate_hardware_mapping_reject_register_shared_sparse(%rows : i32, %cols : i32) attributes {
  public_name = "predicate_hardware_mapping_reject_register_shared_sparse",
  schedule_mode = #vc4tile.schedule_mode<cooperative_block>,
  arg_attrs = [
    {abi_name = "rows", kind = "scalar", direction = "by_value", type = "u32"},
    {abi_name = "cols", kind = "scalar", direction = "by_value", type = "u32"}
...
vc4tile.kernel @predicate_hardware_mapping_reject_shared_register_sparse(%out : i32, %rows : i32, %cols : i32) attributes {
  public_name = "predicate_hardware_mapping_reject_shared_register_sparse",
  schedule_mode = #vc4tile.schedule_mode<cooperative_block>,
  arg_attrs = [
    {abi_name = "out", kind = "buffer", direction = "out", elem_type = "u32", type = "u32"},
    {abi_name = "rows", kind = "scalar", direction = "by_value", type = "u32"},
