...
// CHECK-LABEL: ssavc4.func @plan_shared_global_bounds_predicated
...
vc4tile.kernel @plan_shared_global_bounds_predicated(%out : i32, %rows : i32, %cols : i32) attributes {
  public_name = "plan_shared_global_bounds_predicated",
...
// CHECK-LABEL: ssavc4.func @plan_shared_global_rect_predicated
// CHECK-NOT: vc4tile.copy_tile
// CHECK-NOT: vc4tile.tile_rect_mask
// CHECK-NOT: vc4tile.shared_store_global
// CHECK-COUNT-3: ssavc4.vdw.store_vpm
// CHECK-NOT: ssavc4.vpm.read
// CHECK-NOT: ssavc4.vdw.store
vc4tile.kernel @plan_shared_global_rect_predicated(%out : i32) attributes {
  public_name = "plan_shared_global_rect_predicated",
  schedule_mode = #vc4tile.schedule_mode<cooperative_block>,
