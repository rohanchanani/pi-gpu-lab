...
// CORE-LABEL: vc4tile.kernel @plan_copy_global_shared_bounds_and_tail
// CORE-NOT: vc4tile.copy_tile
// CORE-NOT: vc4tile.vdr_load_tile
// CORE: cf.cond_br
// CORE: vc4tile.tail_mask
// CORE: vc4tile.masked_load_global
// CORE: vc4tile.shared_store

// SSAVC4-LABEL: ssavc4.func @plan_copy_global_shared_bounds_and_tail
// SSAVC4-NOT: ssavc4.vdr.load
// SSAVC4: ssavc4.cond_br
// SSAVC4: ssavc4.tmu.request
// SSAVC4: ssavc4.vpm.write
vc4tile.kernel @plan_copy_global_shared_bounds_and_tail(%in : i32, %rows : i32, %cols : i32, %n : i32) attributes {
  public_name = "plan_copy_global_shared_bounds_and_tail",
