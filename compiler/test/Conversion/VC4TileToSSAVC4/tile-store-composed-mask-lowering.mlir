...
// CHECK-LABEL: ssavc4.func @tile_store_composed_mask_lowering
...
// CHECK-COUNT-20: ssavc4.vdw.store
// CHECK-NOT: ssavc4.vdw.store
vc4tile.kernel @tile_store_composed_mask_lowering(%out : i32, %rows : i32, %cols : i32, %n : i32) attributes {
  public_name = "tile_store_composed_mask_lowering",
  arg_attrs = [
