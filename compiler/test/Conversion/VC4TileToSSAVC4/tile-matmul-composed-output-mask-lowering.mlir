...
// CHECK-LABEL: ssavc4.func @tile_matmul_composed_output_mask_lowering
...
vc4tile.kernel @tile_matmul_composed_output_mask_lowering(%out : i32, %rows : i32, %cols : i32, %n : i32) attributes {
  public_name = "tile_matmul_composed_output_mask_lowering",
  arg_attrs = [
