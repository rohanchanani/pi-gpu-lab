...
// CHECK-LABEL: ssavc4.func @tile_bounds_mask_store_lowering
// CHECK-NOT: vc4tile.tile_bounds_mask
// CHECK-NOT: vc4tile.tile_store
// CHECK-NOT: vc4tile.masked_store_global
// CHECK-COUNT-4: ssavc4.make_flags
// CHECK: ssavc4.cond_br
// CHECK: ssavc4.rotate
// CHECK: ssavc4.vdw.store
vc4tile.kernel @tile_bounds_mask_store_lowering(%out : i32, %rows : i32, %cols : i32) attributes {
  public_name = "tile_bounds_mask_store_lowering",
  arg_attrs = [
