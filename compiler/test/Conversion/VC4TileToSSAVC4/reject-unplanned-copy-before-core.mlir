...
vc4tile.kernel @reject_unplanned_copy(%in : i32, %n : i32) attributes {
  ...
  %tile = "vc4tile.tile_load"(%in, %zero, %mask) {shape = [1, 16], layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>} : (i32, i32, vector<16xi1>) -> vector<16xi32>
  vc4tile.return
}
