...
// CHECK-LABEL: vc4tile.kernel @plan_transpose_view
// CHECK-NOT: vc4tile.transpose_view
// CHECK: vc4tile.shared_load
// CHECK-SAME: #vc4tile.vpm_layout<column_major>
vc4tile.kernel @plan_transpose_view(%out : i32) attributes {
  public_name = "plan_transpose_view",
