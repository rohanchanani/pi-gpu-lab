...
// CHECK-LABEL: ssavc4.func @tile_dot_composed_mask_lowering
...
vc4tile.kernel @tile_dot_composed_mask_lowering(%out : i32, %lhs_base : i32, %rhs_base : i32, %rows : i32, %cols : i32, %n : i32) attributes {
  public_name = "tile_dot_composed_mask_lowering",
  arg_attrs = [
