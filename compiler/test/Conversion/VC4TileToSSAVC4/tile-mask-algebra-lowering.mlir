...
// CHECK-LABEL: ssavc4.func @tile_mask_algebra_lowering
...
vc4tile.kernel @tile_mask_algebra_lowering(%out : i32, %in : i32, %rows : i32, %cols : i32, %n : i32) attributes {
  public_name = "tile_mask_algebra_lowering",
  arg_attrs = [
