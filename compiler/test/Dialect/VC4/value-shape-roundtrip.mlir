...
// CHECK: vc4.func @main(%[[I:.*]]: i32, %[[F:.*]]: f32, %[[VI:.*]]: vector<16xi32>, %[[VF:.*]]: vector<16xf32>, %[[AMT:.*]]: i32) attributes {form = 0 : i32, threading = 0 : i32} {
...
vc4.module @value_shape {
  vc4.func @main(%i: i32, %f: f32, %vi: vector<16xi32>, %vf: vector<16xf32>, %amt: i32) attributes {threading = 0 : i32, form = 0 : i32} {
