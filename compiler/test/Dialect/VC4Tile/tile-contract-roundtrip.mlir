...
vc4tile.kernel @tile_contract_roundtrip(%out : i32, %lhs_base : i32, %rhs_base : i32) attributes {
  ...
  %acc0 = "vc4tile.tile_fill"() {shape = [1, 16], layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<register>, element_type = i32, storage_type = i32, accumulator_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, value = 0 : i32} : () -> vector<16xi32>
