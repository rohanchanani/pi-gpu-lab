...
def audit_p11_dynamic_rotate_shuffle_lock(repo_root, matrix):
    ...
    expected_fixture_tokens = {
        ...
        "fragment_broadcast_lane_composite_vc4kernel": [
            ...
            "#vc4kernel.fp_reduce_policy<finite_tree>",
            "vc4kernel.vdw_store_fragment",
            "#vc4kernel.inactive_store<preserve>",
        ],
    }
    expected_metadata = {
        ...
        "fragment_broadcast_lane_composite_vc4kernel": [
            ...
            "saw_f32_finite_numeric_path",
            "saw_finite_tree_policy",
            "no_ieee_nan_inf_signed_zero_claim",
            "saw_fragment_reduce",
    ...
    for token in [
        ...
        "canonical lowering for vector/value",
        "finite f32 reduction policy",
        "does not claim NaN, Inf, or signed-zero IEEE semantics",
        "P11 mixed fixtures",
    ]:
        if token not in docs:
