...
module {
  vc4kernel.kernel @bad(%x : i32) attributes {
    ...
    %cmp = vc4kernel.fragment_cmp %v, %v {predicate = #vc4kernel.cmp<slt>, fp_policy = #vc4kernel.fp_cmp_policy<finite_only>} : vector<16xi32>, vector<16xi32> -> !vc4kernel.pred<16>
    vc4kernel.return
  }
}
