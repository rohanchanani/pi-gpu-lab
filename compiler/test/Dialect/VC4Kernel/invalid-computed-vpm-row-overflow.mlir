...
module {
  vc4kernel.kernel @hidden_staging_overflow attributes {
    ...
    // CHECK: computed VPM row requirement exceeds 64 rows
    vc4kernel.vdw_store_fragment %c0, %offs, %v, %full {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>, inactive_store = #vc4kernel.inactive_store<preserve>} : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
