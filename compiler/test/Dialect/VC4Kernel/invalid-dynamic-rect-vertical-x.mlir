...
module {
  vc4kernel.kernel @bad(%ptr : i32) attributes {
    ...
    // CHECK: dst_x must be in VPM ADDR range [0, 15]
    vc4kernel.vdr_load_rect_to_vpm %ptr, %c0, %tile, %c0, %c4, %c4, %c4 {max_rows = 4 : i32, max_cols = 4 : i32, elem_bytes = 4 : i32, orientation = #vc4kernel.vpm_orientation<vertical>, width = #vc4kernel.vpm_width<w32>, subword = #vc4kernel.vpm_subword<none>, dst_x = 16 : i32, vpm_pitch = 1 : i32, memory_path = #vc4kernel.memory_path<vdr_global_to_vpm>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, i32, !vc4kernel.vpm_tile, i32, i32, i32, i32
    vc4kernel.return
  }
}
