...
// CHECK-LABEL: ssavc4.module @rotate_roundtrip
// CHECK: ssavc4.rotate
...
// CHECK: ssavc4.unpack
ssavc4.module @rotate_roundtrip {
  ssavc4.func @kernel() attributes {kernel, threading = #vc4.threading_mode<single>} {
    ...
    %dyn = ssavc4.rotate %r, %amount : vector<16xi32>, i32 -> vector<16xi32>
    %p = ssavc4.pack %dyn {mode = #vc4.regfile_a_pack_mode<to_16a>} : vector<16xi32> -> vector<16xi32>
