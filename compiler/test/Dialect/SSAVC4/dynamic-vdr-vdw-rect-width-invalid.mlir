...
ssavc4.module @bad_dynamic_rect_width {
  ssavc4.func @kernel() attributes {kernel, threading = #vc4.threading_mode<single>} {
    ...
    ssavc4.vdr.load_rect.dynamic %addr, %row, %rows, %cols, %pitch {max_rows = 4 : i32, max_cols = 4 : i32, elem_bytes = 2 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, width = #ssavc4.vpm_elem_width<w16>, subword = #ssavc4.vpm_subword<none>, dst_x = 0 : i32, vpm_pitch = 1 : i32, zero_fill = true} : i32, i32, i32, i32, i32
    ssavc4.thread_end
  }
}
