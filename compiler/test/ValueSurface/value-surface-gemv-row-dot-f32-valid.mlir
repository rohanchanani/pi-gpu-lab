...
builtin.module {
  // CHECK-LABEL: func.func @gemv_row_dot_f32
  func.func @gemv_row_dot_f32(
    ...
    %av = vector.transfer_read %a[%c0], %zero {in_bounds = [true]} : memref<?xf32, #vc4value.global>, vector<16xf32>
    %xv = vector.transfer_read %x[%c0], %zero {in_bounds = [true]} : memref<?xf32, #vc4value.global>, vector<16xf32>
    // CHECK: arith.mulf
