...
// Final-stage vc4 input for S1 hidden spill-frame reservation coverage.
// The kernel itself does not perform spills; nonzero spill metadata forces the
// generated runtime ABI to reserve hidden spill storage while the public heap
// still backs the ordinary output buffer allocation/copy path.
vc4.module @spill_frame_reservation_smoke {
  vc4.func @spill_frame_reservation_smoke_kernel() attributes {
    ...
    "vc4.launch_abi" = {
      public_name = "spill_frame_reservation_smoke",
