...
vc4.qpu.vpmvcd_setup_ldi <splat32> {side = #vc4.vpmvcd_side<write>, value = -2138166272 : i32, pm = false, cond_add = #vc4.cond<always>, cond_mul = #vc4.cond<never>, waddr_add = 49 : i32}
