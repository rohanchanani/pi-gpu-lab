...
module attributes {
  ...
  "vc4.hardware_run_test.launch_abi" = {
    ...
    builtins = [
      {name = "logical_request", kind = "logical_request", materialization = "uniform_suffix", uniform_index = 5 : i32},
      {name = "total_requests", kind = "total_requests", materialization = "uniform_suffix", uniform_index = 6 : i32}
    ],
    work_distribution = {
