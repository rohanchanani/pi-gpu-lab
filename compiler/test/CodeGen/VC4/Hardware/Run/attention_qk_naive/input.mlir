...
// Final-stage VC4 scheduled-sink input for the attention_qk_naive hardware-run
// ground-truth test. The trusted runtime bundle implements the semantic
// QK-score reference; the hardware oracle for this corpus entry is the safe
// thread-end kernel shape.
