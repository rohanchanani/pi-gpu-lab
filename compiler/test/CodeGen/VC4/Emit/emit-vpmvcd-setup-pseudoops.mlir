...
// RUN: test -f %t.bundle/kernels/vpmvcd_setup_pseudoops.qasm
// RUN: FileCheck %s --check-prefix=QASM --input-file=%t.bundle/kernels/vpmvcd_setup_pseudoops.qasm

// QASM: mov vr_setup, r2
// QASM-NEXT: mov vw_setup, r3
// QASM-NEXT: thrend
// QASM-NEXT: nop
// QASM-NEXT: nop

vc4.module @vpmvcd_setup_pseudoops {
  vc4.func @kernel() attributes {
    ...
    "vc4.launch_abi" = {
      public_name = "vpmvcd_setup_pseudoops",
