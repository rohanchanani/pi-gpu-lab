...
// CHECK: found an earlier vc4.qpu.bundle with sig = #vc4.qpu_signal<thrend> before slot N-3

vc4.module @vc4_codegen_emit_contract_duplicate_thrend {
  vc4.func @duplicate_thrend_kernel() attributes {
    domain = #vc4.execution_domain<qpu>,
    form = #vc4.function_form<scheduled>,
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "duplicate_thrend_launch",
