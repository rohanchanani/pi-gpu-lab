...
// CHECK: "vc4.launch_abi" requires a non-empty string 'public_name'
// CHECK: vc4-codegen: error: failed to parse

vc4.module @vc4_codegen_emit_contract_bad_launch_abi {
  vc4.func @bad_launch_abi_kernel() attributes {
