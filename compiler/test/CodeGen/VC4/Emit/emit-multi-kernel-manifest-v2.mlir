...
// RUN: python3 %S/../Support/check_m2_manifest.py %t.bundle/manifest.json --schema-version 2 --kernel-count 2 --require-target --require-kernel-fields --public-name minimal_thrend --public-name memory_output
