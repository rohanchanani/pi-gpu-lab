...
// CHECK: only slot N-3 may carry sig = #vc4.qpu_signal<thrend>
// CHECK: slots N-2 and N-1 must be non-branch scheduled ops without another thread-end signal

vc4.module @vc4_codegen_emit_contract_tail_duplicate_thrend {
  vc4.func @tail_duplicate_thrend_kernel() attributes {
