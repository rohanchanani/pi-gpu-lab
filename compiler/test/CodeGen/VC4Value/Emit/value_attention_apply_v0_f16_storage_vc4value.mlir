...
// RUN: vc4-opt %s --vc4-verify-value-surface --convert-vc4-value-to-vc4kernel -o %t/value_attention_apply_v0_f16.vc4kernel.mlir
// RUN: FileCheck %s --check-prefix=VC4KERNEL --input-file=%t/value_attention_apply_v0_f16.vc4kernel.mlir
// RUN: vc4-opt %t/value_attention_apply_v0_f16.vc4kernel.mlir --verify-vc4kernel --convert-vc4kernel-to-ssavc4 -o %t/value_attention_apply_v0_f16.ssavc4.mlir
// RUN: FileCheck %s --check-prefix=SSAVC4 --input-file=%t/value_attention_apply_v0_f16.ssavc4.mlir
// RUN: vc4-opt %t/value_attention_apply_v0_f16.ssavc4.mlir --convert-ssavc4-to-vc4 --vc4-verify-emit-contract --vc4-verify-scheduled-hardware-rules --vc4-verify-scheduled-adjacent-hazards --vc4-verify-scheduled-io-spacing --vc4-verify-scheduled-peripheral-accesses -o %t/value_attention_apply_v0_f16.vc4.mlir
// RUN: FileCheck %s --check-prefix=VC4 --input-file=%t/value_attention_apply_v0_f16.vc4.mlir

func.func @value_attention_apply_v0_f16_storage_vc4value(
...
// VC4KERNEL-LABEL: vc4kernel.kernel @value_attention_apply_v0_f16_storage_vc4value
// VC4KERNEL: vc4kernel.vdr_load_rect_to_vpm
// VC4KERNEL-SAME: elem_bytes = 2
...
// SSAVC4-LABEL: ssavc4.func @value_attention_apply_v0_f16_storage_vc4value
