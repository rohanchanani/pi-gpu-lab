func.func @value_multi_axis_tail_cf_vc4value(
...
^store:
  ...
  %bias = arith.constant 7 : i32
  %pid1_part = arith.muli %pid1_i32, %scale_pid1 : i32
  %pid0_part = arith.muli %pid0_i32, %scale_pid0 : i32
  %partial = arith.addi %pid1_part, %pid0_part : i32
  %encoded_scalar = arith.addi %partial, %bias : i32
