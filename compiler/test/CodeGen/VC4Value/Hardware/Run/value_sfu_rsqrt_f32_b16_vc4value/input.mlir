func.func @value_sfu_rsqrt_f32_b16_vc4value(
  ...
  %r = math.rsqrt %active : vector<16xf32>
  vector.transfer_write %r, %y[%base], %mask {in_bounds = [true]} : vector<16xf32>, memref<?xf32, #vc4value.global>
  return
}
