func.func @value_ranked_memory_repeat_empty_vc4value(
  ...
  %dim_rows = memref.dim %out, %c0 : memref<?x?xi32, strided<[?, 1], offset: 0>, #vc4value.global>
  %dim_cols = memref.dim %out, %c1 : memref<?x?xi32, strided<[?, 1], offset: 0>, #vc4value.global>
