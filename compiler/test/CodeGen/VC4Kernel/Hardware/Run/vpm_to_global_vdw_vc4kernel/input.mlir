module {
  vc4kernel.kernel @vpm_to_global_vdw_vc4kernel(%out : i32, %n : i32) attributes {
    ...
    %base0v = vc4kernel.fragment_const {value = dense<1375731712> : vector<16xi32>} : vector<16xi32>
    %base1v = vc4kernel.fragment_const {value = dense<1392508928> : vector<16xi32>} : vector<16xi32>
