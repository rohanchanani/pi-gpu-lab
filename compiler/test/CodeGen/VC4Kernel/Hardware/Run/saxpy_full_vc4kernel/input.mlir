module {
  vc4kernel.kernel @saxpy_full_vc4kernel(%x : i32, %y : i32, %alpha : f32, %n : i32) attributes {
    ...
    %scaled = vc4kernel.fragment_mul %alpha_v, %xv : vector<16xf32>, vector<16xf32> -> vector<16xf32>
    %sum = vc4kernel.fragment_add %scaled, %yv : vector<16xf32>, vector<16xf32> -> vector<16xf32>
