module {
  vc4kernel.kernel @fragment_reduce_i32_add_bitwise_vc4kernel(%input : i32, %out : i32) attributes {
    ...
    %values = vc4kernel.tmu_load_fragment %input, %lane_bytes, %full : i32, vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    vc4kernel.vdw_store_fragment %out, %off1, %r1, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off2, %r2, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off3, %r3, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off4, %r4, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off5, %r5, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off6, %r6, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off7, %r7, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off8, %r8, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off9, %r9, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off10, %r10, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off11, %r11, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off12, %r12, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off13, %r13, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off14, %r14, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off15, %r15, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off16, %r16, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off17, %r17, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off18, %r18, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %off19, %r19, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
