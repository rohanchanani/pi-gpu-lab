module {
  vc4kernel.kernel @mixed_blocked_gemv_vpm_fullstack_vc4kernel(%a : i32, %x : i32, %y : i32, %m : i32, %n : i32, %lda : i32, %alpha : f32, %bias : f32, %threshold : f32) attributes {
    public_name = "mixed_blocked_gemv_vpm_fullstack_vc4kernel",
  ...
  ^store(%sum : vector<16xf32>):
    ...
    vc4kernel.vdw_store_fragment %y, %offs, %selected, %row_tail {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>, inactive_store = #vc4kernel.inactive_store<preserve>} : i32, vector<16xi32>, vector<16xf32>, !vc4kernel.pred<16>
    vc4kernel.return
