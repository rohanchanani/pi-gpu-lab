module {
  vc4kernel.kernel @blocked_gemm_vpm_tile_compute_tail_vc4kernel(%a : i32, %b : i32, %c : i32, %active_cols : i32, %active_k : i32) attributes {
    public_name = "blocked_gemm_vpm_tile_compute_tail_vc4kernel",
    ...
    arg_attrs = [
      ...
      {name = "active_k", kind = "scalar", direction = "by_value", type = "i32"}
    ],
    ...
    vc4kernel.vdr_load_rect_to_vpm %a, %c0, %a_tile, %c0, %c1, %active_k, %a_pitch {max_rows = 1 : i32, max_cols = 4 : i32, elem_bytes = 4 : i32, orientation = #vc4kernel.vpm_orientation<horizontal>, width = #vc4kernel.vpm_width<w32>, subword = #vc4kernel.vpm_subword<none>, dst_x = 0 : i32, vpm_pitch = 1 : i32, memory_path = #vc4kernel.memory_path<vdr_global_to_vpm>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, i32, !vc4kernel.vpm_tile, i32, i32, i32, i32
    vc4kernel.vdr_load_rect_to_vpm %b, %c0, %b_tile, %c0, %active_k, %active_cols, %b_pitch {max_rows = 4 : i32, max_cols = 16 : i32, elem_bytes = 4 : i32, orientation = #vc4kernel.vpm_orientation<horizontal>, width = #vc4kernel.vpm_width<w32>, subword = #vc4kernel.vpm_subword<none>, dst_x = 0 : i32, vpm_pitch = 1 : i32, memory_path = #vc4kernel.memory_path<vdr_global_to_vpm>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, i32, !vc4kernel.vpm_tile, i32, i32, i32, i32
    ...
    vc4kernel.vdw_store_fragment %c, %lane_bytes, %acc3, %tail {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>, inactive_store = #vc4kernel.inactive_store<preserve>} : i32, vector<16xi32>, vector<16xf32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
