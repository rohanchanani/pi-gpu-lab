module {
  vc4kernel.kernel @scalar_i32_mul32_exact_vc4kernel(%out : i32, %a : i32, %b : i32, %offset_elems : i32) attributes {
    public_name = "scalar_i32_mul32_exact_vc4kernel",
    ...
    %base_v = vc4kernel.splat %offset_bytes : i32 -> vector<16xi32>
    %byte_offsets = vc4kernel.fragment_alu.add %base_v, %lane_bytes {opcode = #vc4kernel.add_alu_opcode<add>} : (vector<16xi32>, vector<16xi32>) -> vector<16xi32>
    %product = arith.muli %a, %b : i32
    %value = vc4kernel.splat %product : i32 -> vector<16xi32>
