module {
  vc4kernel.kernel @memory_path_explicit_vpm_qpu_vc4kernel(%out : i32) attributes {
    public_name = "memory_path_explicit_vpm_qpu_vc4kernel",
    ...
    %base_v = vc4kernel.fragment_const {value = dense<1895825408> : vector<16xi32>} : vector<16xi32>
