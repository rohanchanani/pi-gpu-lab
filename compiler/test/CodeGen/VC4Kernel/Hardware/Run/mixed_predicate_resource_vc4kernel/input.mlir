module {
  vc4kernel.kernel @mixed_predicate_resource_vc4kernel(%out : i32, %n : i32, %threshold : i32, %control : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %byte_offsets, %read, %tail {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
