...
void notmain(void) {
  ...
  if (vc4_program_create(&program, 0) < 0 || !program)
    panic("dynamic_vpm_64_capacity_rect_tiles_vc4kernel program create failed");
  if (vc4_m2_malloc(program, &input0_dev, sizeof(input0)) < 0 ||
      vc4_m2_malloc(program, &input16_dev, sizeof(input16)) < 0 ||
      vc4_m2_malloc(program, &input32_dev, sizeof(input32)) < 0 ||
      vc4_m2_malloc(program, &input48_dev, sizeof(input48)) < 0 ||
      vc4_m2_malloc(program, &output0_dev, sizeof(output0)) < 0 ||
      vc4_m2_malloc(program, &output16_dev, sizeof(output16)) < 0 ||
      vc4_m2_malloc(program, &output32_dev, sizeof(output32)) < 0 ||
      vc4_m2_malloc(program, &output48_dev, sizeof(output48)) < 0)
    panic("dynamic_vpm_64_capacity_rect_tiles_vc4kernel allocation failed");
  ...
  if (vc4_m2_copy_htod(program, input0_dev, input0, sizeof(input0)) < 0 ||
      vc4_m2_copy_htod(program, input16_dev, input16, sizeof(input16)) < 0 ||
      vc4_m2_copy_htod(program, input32_dev, input32, sizeof(input32)) < 0 ||
      vc4_m2_copy_htod(program, input48_dev, input48, sizeof(input48)) < 0 ||
      vc4_m2_copy_htod(program, output0_dev, output0, sizeof(output0)) < 0 ||
      vc4_m2_copy_htod(program, output16_dev, output16, sizeof(output16)) < 0 ||
      vc4_m2_copy_htod(program, output32_dev, output32, sizeof(output32)) < 0 ||
      vc4_m2_copy_htod(program, output48_dev, output48, sizeof(output48)) < 0 ||
      dynamic_vpm_64_capacity_rect_tiles_vc4kernel_launch(
      ...
      vc4_m2_copy_dtoh(program, input0, input0_dev, sizeof(input0)) < 0 ||
      vc4_m2_copy_dtoh(program, input16, input16_dev, sizeof(input16)) < 0 ||
      vc4_m2_copy_dtoh(program, input32, input32_dev, sizeof(input32)) < 0 ||
      vc4_m2_copy_dtoh(program, input48, input48_dev, sizeof(input48)) < 0 ||
      vc4_m2_copy_dtoh(program, output0, output0_dev, sizeof(output0)) < 0 ||
      vc4_m2_copy_dtoh(program, output16, output16_dev, sizeof(output16)) < 0 ||
      vc4_m2_copy_dtoh(program, output32, output32_dev, sizeof(output32)) < 0 ||
      vc4_m2_copy_dtoh(program, output48, output48_dev, sizeof(output48)) < 0) {
  ...
  uint32_t runtime_launches =
      dynamic_vpm_64_capacity_rect_tiles_vc4kernel_runtime_launches();
  launch_failures +=
      dynamic_vpm_64_capacity_rect_tiles_vc4kernel_runtime_launch_failures();
  const char *status =
      (total_mismatches == 0 && sentinel_mismatches == 0 &&
       ...
       runtime_launches == 1)
          ? "PASS"
          : "FAIL";
  printk("VC4_TEST_RESULT name=dynamic_vpm_64_capacity_rect_tiles_vc4kernel status=%s cases=1 total_mismatches=%d sentinel_mismatches=%d source_guard_mismatches=%d launch_failures=%d runtime_launches=%d checksum_accum=%u row_bases=0,16,32,48\n",
