module {
  vc4kernel.kernel @f32_fragment_arith_vc4kernel(%out : i32, %alpha : f32, %beta : f32, %offset_elems : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %byte_offsets, %value, %full {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, vector<16xi32>, vector<16xf32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
