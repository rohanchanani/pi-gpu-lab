module {
  vc4kernel.kernel @gemm_blocked_vpm_one_tile_vc4kernel(%a : i32, %b : i32, %c : i32, %m : i32, %n : i32, %k : i32) attributes {
    public_name = "gemm_blocked_vpm_one_tile_vc4kernel",
    ...
    %a_pitch = arith.shli %k, %c2 : i32
    %b_pitch = arith.shli %n, %c2 : i32
    ...
    vc4kernel.vdr_load_rect_to_vpm %a, %c0, %a_tile, %c0, %m, %k, %a_pitch {max_rows = 1 : i32, max_cols = 4 : i32, elem_bytes = 4 : i32, orientation = #vc4kernel.vpm_orientation<horizontal>, width = #vc4kernel.vpm_width<w32>, subword = #vc4kernel.vpm_subword<none>, dst_x = 0 : i32, vpm_pitch = 1 : i32, memory_path = #vc4kernel.memory_path<vdr_global_to_vpm>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, i32, !vc4kernel.vpm_tile, i32, i32, i32, i32
    vc4kernel.vdr_load_rect_to_vpm %b, %c0, %b_tile, %c0, %k, %n, %b_pitch {max_rows = 4 : i32, max_cols = 16 : i32, elem_bytes = 4 : i32, orientation = #vc4kernel.vpm_orientation<horizontal>, width = #vc4kernel.vpm_width<w32>, subword = #vc4kernel.vpm_subword<none>, dst_x = 0 : i32, vpm_pitch = 1 : i32, memory_path = #vc4kernel.memory_path<vdr_global_to_vpm>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, i32, !vc4kernel.vpm_tile, i32, i32, i32, i32
