module {
  vc4kernel.kernel @fragment_reduce_i32_unsigned_minmax_vc4kernel(%input : i32, %out : i32) attributes {
    public_name = "fragment_reduce_i32_unsigned_minmax_vc4kernel",
    ...
    %r0 = vc4kernel.fragment_reduce %values, %full {kind = #vc4kernel.reduce<min_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r1 = vc4kernel.fragment_reduce %values, %empty {kind = #vc4kernel.reduce<min_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r2 = vc4kernel.fragment_reduce %values, %one_hot {kind = #vc4kernel.reduce<min_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r3 = vc4kernel.fragment_reduce %values, %sparse {kind = #vc4kernel.reduce<min_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r4 = vc4kernel.fragment_reduce %values, %full {kind = #vc4kernel.reduce<max_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r5 = vc4kernel.fragment_reduce %values, %empty {kind = #vc4kernel.reduce<max_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r6 = vc4kernel.fragment_reduce %values, %one_hot {kind = #vc4kernel.reduce<max_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
    ...
    %r7 = vc4kernel.fragment_reduce %values, %sparse {kind = #vc4kernel.reduce<max_u>} : vector<16xi32>, !vc4kernel.pred<16> -> vector<16xi32>
