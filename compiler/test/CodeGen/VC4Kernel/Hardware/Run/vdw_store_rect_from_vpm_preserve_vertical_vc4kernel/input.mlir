module {
  vc4kernel.kernel @vdw_store_rect_from_vpm_preserve_vertical_vc4kernel(%in : i32, %out : i32, %active_rows : i32, %active_cols : i32, %pitch_stride : i32) attributes {
    public_name = "vdw_store_rect_from_vpm_preserve_vertical_vc4kernel",
