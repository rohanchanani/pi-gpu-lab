module {
  ...
  ^signed_less:
    ...
    vc4kernel.vdw_store_fragment %out, %off10t, %vt, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    cf.br ^done
  ^not_signed_less:
    ...
    vc4kernel.vdw_store_fragment %out, %off10f, %vf, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    cf.br ^done
  ^done:
    vc4kernel.return
  }
