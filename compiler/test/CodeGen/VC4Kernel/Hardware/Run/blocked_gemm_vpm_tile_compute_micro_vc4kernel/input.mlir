module {
  vc4kernel.kernel @blocked_gemm_vpm_tile_compute_micro_vc4kernel(%a : i32, %b : i32, %c : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %c, %lane_bytes, %acc3, %full {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>} : i32, vector<16xi32>, vector<16xf32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
