module {
  vc4kernel.kernel @dynamic_vdr_vdw_rect_roundtrip_vc4kernel(%in : i32, %out : i32, %active_rows : i32, %active_cols : i32, %pitch : i32, %stride : i32) attributes {
    public_name = "dynamic_vdr_vdw_rect_roundtrip_vc4kernel",
