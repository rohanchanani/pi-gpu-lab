module {
  vc4kernel.kernel @mixed_double_buffered_vpm_tiles_vc4kernel(%in : i32, %out : i32, %n : i32, %row : i32, %word_x : i32, %sel8 : i32, %amount : i32) attributes {
    public_name = "mixed_double_buffered_vpm_tiles_vc4kernel",
