module {
  vc4kernel.kernel @fragment_const_splat_vc4kernel(%out : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %lane_bytes, %s0, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %o1, %s1, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %o2, %s2, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %o3, %f0_bits, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %o4, %f1_bits, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %o5, %f2_bits, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    ...
    vc4kernel.vdw_store_fragment %out, %o6, %f3_bits, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
