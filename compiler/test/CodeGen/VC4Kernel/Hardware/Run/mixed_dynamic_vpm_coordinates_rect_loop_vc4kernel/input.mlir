module {
  vc4kernel.kernel @mixed_dynamic_vpm_coordinates_rect_loop_vc4kernel(%in : i32, %out : i32, %iters : i32, %active_cols : i32) attributes {
    public_name = "mixed_dynamic_vpm_coordinates_rect_loop_vc4kernel",
