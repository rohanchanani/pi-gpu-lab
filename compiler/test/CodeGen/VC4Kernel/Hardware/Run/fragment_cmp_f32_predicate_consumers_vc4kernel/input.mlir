module {
  ...
  ^any_merge(%any_value : vector<16xi32>):
    ...
    vc4kernel.vdw_store_fragment %out, %offs4, %any_value, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
  ...
  ^all_merge(%all_value : vector<16xi32>):
    ...
    vc4kernel.vdw_store_fragment %out, %offs5, %all_value, %full : i32, vector<16xi32>, vector<16xi32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
