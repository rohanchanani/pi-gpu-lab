module {
  vc4kernel.kernel @arith_select_scalar_vc4kernel(%out : i32, %control : i32, %alpha : f32, %beta : f32, %offset_elems : i32) attributes {
    ...
    vc4kernel.vdw_store_fragment %out, %byte_offsets, %value, %full {memory_path = #vc4kernel.memory_path<vdw_global_store>, coherency = #vc4kernel.coherency<dma_ordered>, inactive_store = #vc4kernel.inactive_store<preserve>} : i32, vector<16xi32>, vector<16xf32>, !vc4kernel.pred<16>
    vc4kernel.return
  }
}
