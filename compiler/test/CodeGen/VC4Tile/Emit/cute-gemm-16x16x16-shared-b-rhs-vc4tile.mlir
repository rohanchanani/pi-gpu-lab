// RUN: vc4-opt %S/../Hardware/Run/cute_gemm_16x16x16_shared_b_rhs_vc4tile/input.mlir --canonicalize-vc4tile-surface --plan-vc4tile-copies --legalize-vc4tile-core-cfg --verify-vc4tile-core --convert-vc4tile-to-ssavc4 -o - | FileCheck --check-prefix=SSAVC4 %s
// RUN: vc4-opt %S/../Hardware/Run/cute_gemm_16x16x16_shared_b_rhs_vc4tile/input.mlir --canonicalize-vc4tile-surface --plan-vc4tile-copies --legalize-vc4tile-core-cfg --verify-vc4tile-core --convert-vc4tile-to-ssavc4 | vc4-opt --convert-ssavc4-to-vc4 --vc4-verify-emit-contract --vc4-verify-scheduled-hardware-rules --vc4-verify-scheduled-adjacent-hazards --vc4-verify-scheduled-io-spacing --vc4-verify-scheduled-peripheral-accesses | FileCheck --check-prefix=VC4 %s

// SSAVC4-LABEL: ssavc4.func @cute_gemm_16x16x16_shared_b_rhs_vc4tile
...
// SSAVC4: %[[VPM_BASE:.*]] = ssavc4.uniform.read 7 : i32
...
// VC4-LABEL: vc4.func @cute_gemm_16x16x16_shared_b_rhs_vc4tile
// VC4-NOT: ssavc4.
// VC4-NOT: vc4tile.
// VC4: vc4.qpu.bundle
// VC4: small_imm = 4 : i32
// VC4: vc4.qpu.vpmvcd_setup
// VC4-SAME: add_b = #vc4.qpu_mux<r1>
// VC4-SAME: side = #vc4.vpmvcd_side<read>
