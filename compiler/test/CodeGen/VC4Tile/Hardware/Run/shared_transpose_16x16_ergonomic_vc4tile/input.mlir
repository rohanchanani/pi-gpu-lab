...
vc4tile.kernel @shared_transpose_16x16_ergonomic_vc4tile(%out : i32, %in : i32) attributes {
  ...
  "vc4tile.tile_store"(%view, %out, %off1, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 1 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off2, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 2 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off3, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 3 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off4, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 4 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off5, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 5 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off6, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 6 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off7, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 7 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off8, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 8 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off9, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 9 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off10, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 10 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off11, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 11 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off12, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 12 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off13, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 13 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off14, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 14 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  "vc4tile.tile_store"(%view, %out, %off15, %mask) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, shared_row = 15 : i32} : (!vc4tile.shared_tile, i32, i32, vector<16xi1>) -> ()
  vc4tile.return
}
