// RUN: bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh tile_matmul_bounds_output_mask_vc4tile generate

vc4tile.kernel @tile_matmul_bounds_output_mask_vc4tile(%out : i32, %rows : i32, %cols : i32) attributes {
  public_name = "tile_matmul_bounds_output_mask_vc4tile",
  arg_attrs = [
