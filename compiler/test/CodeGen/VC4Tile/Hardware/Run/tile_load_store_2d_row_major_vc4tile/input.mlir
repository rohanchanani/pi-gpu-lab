// RUN: bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh tile_load_store_2d_row_major_vc4tile generate

vc4tile.kernel @tile_load_store_2d_row_major_vc4tile(%out : i32, %in : i32) attributes {
  public_name = "tile_load_store_2d_row_major_vc4tile",
  ...
  %r0 = "vc4tile.tile_load"(%in, %zero, %mask) {
  ...
  %r1 = "vc4tile.tile_load"(%in, %row1, %mask) {
    shape = [1, 16], src_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>,
    element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>
  } : (i32, i32, !vc4tile.predicate) -> vector<16xi32>
  "vc4tile.tile_store"(%r0, %out, %zero, %mask) {
  ...
  "vc4tile.tile_store"(%r1, %out, %row1, %mask) {
    shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>,
    element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>
  } : (vector<16xi32>, i32, i32, !vc4tile.predicate) -> ()
  vc4tile.return
