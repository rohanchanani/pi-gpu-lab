...
vc4tile.kernel @cute_gemm_tail_17x13x9_vc4tile(%out : i32, %a : i32, %b : i32) attributes {
  ...
  %mask_a_k_tail = vc4tile.tile_rect_mask {active_rows = 4 : i32, active_cols = 1 : i32, shape = [4, 4], layout = #vc4tile.layout<row_major>}
  %mask_b_k_tail = vc4tile.tile_rect_mask {active_rows = 1 : i32, active_cols = 4 : i32, shape = [4, 4], layout = #vc4tile.layout<row_major>}
  ...
  %store_mask = vc4tile.tile_bounds_mask %store_rows, %store_cols {shape = [4, 4], layout = #vc4tile.layout<row_major>} : i32, i32
  ...
  %lhs_0 = "vc4tile.tile_load"(%a, %a_off_0, %mask) {shape = [4, 4], src_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, boundary = #vc4tile.boundary_policy<exact>, packing = #vc4tile.packing<none>} : (i32, i32, !vc4tile.predicate) -> vector<16xi32>
  %rhs_0 = "vc4tile.tile_load"(%b, %b_off_0, %mask) {shape = [4, 4], src_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, boundary = #vc4tile.boundary_policy<exact>, packing = #vc4tile.packing<none>} : (i32, i32, !vc4tile.predicate) -> vector<16xi32>
  ...
  %lhs_1 = "vc4tile.tile_load"(%a, %a_off_1, %mask) {shape = [4, 4], src_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, boundary = #vc4tile.boundary_policy<exact>, packing = #vc4tile.packing<none>} : (i32, i32, !vc4tile.predicate) -> vector<16xi32>
  %rhs_1 = "vc4tile.tile_load"(%b, %b_off_1, %mask) {shape = [4, 4], src_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, boundary = #vc4tile.boundary_policy<exact>, packing = #vc4tile.packing<none>} : (i32, i32, !vc4tile.predicate) -> vector<16xi32>
  ...
  "vc4tile.tile_store"(%acc3, %out, %out_tile_base, %store_mask) {shape = [4, 4], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, boundary = #vc4tile.boundary_policy<exact>, packing = #vc4tile.packing<none>, memory_pitch_bytes = 52 : i32} : (vector<16xi32>, i32, i32, !vc4tile.predicate) -> ()
