// RUN: bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh boundary_tail_predicated_load_store_vc4tile generate

vc4tile.kernel @boundary_tail_predicated_load_store_vc4tile(%out : i32, %in : i32, %n : i32) attributes {
  public_name = "boundary_tail_predicated_load_store_vc4tile",
