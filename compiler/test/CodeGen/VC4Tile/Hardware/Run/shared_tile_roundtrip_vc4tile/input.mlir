...
vc4tile.kernel @shared_tile_roundtrip_vc4tile(%out : i32) attributes {
  ...
  "vc4tile.tile_store"(%loaded, %out, %off0, %mask) {shape = [1, 16], layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>} : (vector<16xi32>, i32, i32, vector<16xi1>) -> ()
  vc4tile.return
}
