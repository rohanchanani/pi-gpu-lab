...
vc4tile.kernel @global_store_coalesced_multi_vc4tile attributes {
  ...
  launch_abi = {
    public_name = "global_store_coalesced_multi_vc4tile",
    code_symbol = "global_store_coalesced_multi_vc4tile_shader",
    tail_policy = "exact_multiple",
    uniform_words_per_qpu = 2 : i32,
    args = [
      {direction = "by_value", kind = "scalar", name = "out", type = "u32", uniform_index = 0 : i32},
      {direction = "by_value", kind = "scalar", name = "n", type = "u32", uniform_index = 1 : i32}
    ],
    builtins = []
  }
} {
  %base = vc4tile.program_id {uniform_index = 0 : i32} : i32
  %n = vc4tile.program_id {uniform_index = 1 : i32} : i32
