...
// RUN: bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh scf_for_tail_mask_store_vc4tile clean
// RUN: bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh scf_for_tail_mask_store_vc4tile generate
// RUN: bash -c 'd="$(bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh scf_for_tail_mask_store_vc4tile generated-dir)"; FileCheck --check-prefix=CORE %s < "$d/core.vc4tile.mlir"'

// RAW: legalize-vc4tile-core-cfg
// SSAVC4: ssavc4.func @scf_for_tail_mask_store_vc4tile
...
vc4tile.kernel @scf_for_tail_mask_store_vc4tile attributes {
  public_name = "scf_for_tail_mask_store_vc4tile",
