...
vc4tile.kernel @tile_dot_tail_1x16_i32_vc4tile(%out : i32, %lhs_base : i32, %rhs_base : i32, %n : i32) attributes {
  ...
  "vc4tile.tile_store"(%result, %out, %zero, %all) {shape = [1, 16], dst_layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<global>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>, role = #vc4tile.role<output>} : (vector<16xi32>, i32, i32, vector<16xi1>) -> ()
  vc4tile.return
}
