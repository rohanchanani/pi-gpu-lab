...
vc4tile.kernel @tile_masked_select_tail_vc4tile(%out : i32, %x : i32, %n : i32) attributes {
  ...
  %sel = "vc4tile.tile_select"(%mask, %xv, %fallback) {shape = [1, 16], layout = #vc4tile.layout<row_major>, memory_space = #vc4tile.memory_space<register>, element_type = i32, storage_type = i32, precision = #vc4tile.precision<exact_32>, packing = #vc4tile.packing<none>} : (!vc4tile.predicate, vector<16xi32>, vector<16xi32>) -> vector<16xi32>
