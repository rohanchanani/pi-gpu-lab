// RUN: bash %S/../../../Support/run_vc4tile_candidate_codegen_test.sh tile_load_1d_tail_vc4tile generate

vc4tile.kernel @tile_load_1d_tail_vc4tile(%out : i32, %in : i32, %n : i32) attributes {
  public_name = "tile_load_1d_tail_vc4tile",
