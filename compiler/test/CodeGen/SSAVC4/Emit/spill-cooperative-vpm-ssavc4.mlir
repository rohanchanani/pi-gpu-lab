...
// RUN: test -f %t.bundle/kernels/spill_cooperative_vpm.qasm
...
// LOWERED-LABEL: vc4.func @spill_cooperative_vpm_kernel
...
// SOURCE: uniformWords[1] = requestInfo->vpm_base_row + KERNEL_0_USER_VPM_ROWS_PER_BLOCK + KERNEL_0_COMPILER_VPM_STAGING_ROWS_PER_BLOCK + KERNEL_0_WARPS_PER_BLOCK * KERNEL_0_COMPILER_VPM_STAGING_ROWS_PER_WARP + requestInfo->logical_warp_id; /* builtin spill_vpm_row */
...
ssavc4.module @spill_cooperative_vpm {
  ssavc4.func @spill_cooperative_vpm_kernel() attributes {
    ...
    "vc4.launch_abi" = {
      public_name = "spill_cooperative_vpm",
