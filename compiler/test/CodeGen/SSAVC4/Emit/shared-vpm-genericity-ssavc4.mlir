...
ssavc4.module @neutral_shared_vpm_codegen {
  ssavc4.func @neutral_shared_vpm_kernel() attributes {
    ...
    ssavc4.vpm.write %row1, %read {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, x = 0 : i32, stride = 1 : i32, lanes = 16 : i32, orientation = #ssavc4.vpm_orientation<horizontal>} : i32, vector<16xi32>
    ssavc4.thread_end
  }
}
