ssavc4.module @large_spill_frame_multi_resident_ssavc4 {
  ssavc4.func @large_spill_frame_multi_resident_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "large_spill_frame_multi_resident_ssavc4",
      code_symbol = "large_spill_frame_multi_resident_ssavc4_shader",
      tail_policy = "exact_multiple",
      uniform_words_per_qpu = 7 : i32,
      args = [
        {name = "out", kind = "buffer", direction = "out", elem_type = "f32", uniform_index = 0 : i32},
        {name = "ids", kind = "buffer", direction = "out", elem_type = "u32", uniform_index = 1 : i32},
    ...
    %ids_base = ssavc4.uniform.read 1 : i32
