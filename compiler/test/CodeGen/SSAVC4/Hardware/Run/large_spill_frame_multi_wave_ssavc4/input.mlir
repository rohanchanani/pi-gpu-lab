ssavc4.module @large_spill_frame_multi_wave_ssavc4 {
  ssavc4.func @large_spill_frame_multi_wave_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "large_spill_frame_multi_wave_ssavc4",
      code_symbol = "large_spill_frame_multi_wave_ssavc4_shader",
