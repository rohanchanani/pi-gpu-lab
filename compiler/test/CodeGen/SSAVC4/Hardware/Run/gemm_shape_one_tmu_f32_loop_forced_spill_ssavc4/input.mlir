ssavc4.module @gemm_shape_one_tmu_f32_loop_forced_spill_ssavc4 {
  ssavc4.func @gemm_shape_one_tmu_f32_loop_forced_spill_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "gemm_shape_one_tmu_f32_loop_forced_spill_ssavc4",
      code_symbol = "gemm_shape_one_tmu_f32_loop_forced_spill_ssavc4_shader",
  ...
  ^step(%iter_step: i32, %acc_step: vector<16xf32>):
    ...
    %acc_next = ssavc4.alu.add %acc_step, %b_val {opcode = #vc4.add_opcode<fadd>} : (vector<16xf32>, vector<16xf32>) -> vector<16xf32>
