ssavc4.module @spill_pressure_smoke_ssavc4 {
  ssavc4.func @spill_pressure_smoke_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "spill_pressure_smoke_ssavc4",
      code_symbol = "spill_pressure_smoke_ssavc4_shader",
