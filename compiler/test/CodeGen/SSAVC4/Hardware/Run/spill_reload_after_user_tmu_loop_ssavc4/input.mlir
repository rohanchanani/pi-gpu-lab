ssavc4.module @spill_reload_after_user_tmu_loop_ssavc4 {
  ssavc4.func @spill_reload_after_user_tmu_loop_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "spill_reload_after_user_tmu_loop_ssavc4",
      code_symbol = "spill_reload_after_user_tmu_loop_ssavc4_shader",
  ...
  ^step(%iter_step: i32, %acc_step: vector<16xf32>):
    ...
    %with_user = ssavc4.alu.add %acc_step, %x_val {opcode = #vc4.add_opcode<fadd>} : (vector<16xf32>, vector<16xf32>) -> vector<16xf32>
    %acc_next = ssavc4.alu.add %with_user, %p01 {opcode = #vc4.add_opcode<fadd>} : (vector<16xf32>, vector<16xf32>) -> vector<16xf32>
