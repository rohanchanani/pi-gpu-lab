ssavc4.module @f32_tail_vpmread_loop_no_spill_ssavc4 {
  ssavc4.func @f32_tail_vpmread_loop_no_spill_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "f32_tail_vpmread_loop_no_spill_ssavc4",
      code_symbol = "f32_tail_vpmread_loop_no_spill_ssavc4_shader",
  ...
  ^loop(%iter: i32, %acc: vector<16xf32>):
    ...
    ssavc4.cond_br %done_flags, ^store(%acc : vector<16xf32>), ^step(%iter, %acc : i32, vector<16xf32>) {cond = #vc4.branch_cond<any_c_clear>} : !ssavc4.flags
