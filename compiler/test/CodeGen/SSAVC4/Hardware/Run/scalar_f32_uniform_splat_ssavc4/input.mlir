ssavc4.module @scalar_f32_uniform_splat_ssavc4 {
  ssavc4.func @scalar_f32_uniform_splat_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "scalar_f32_uniform_splat_ssavc4",
      code_symbol = "scalar_f32_uniform_splat_ssavc4_shader",
