ssavc4.module @dynamic_vdw_runtime_rows_preserve_ssavc4 {
  ssavc4.func @dynamic_vdw_runtime_rows_preserve_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_vdw_runtime_rows_preserve_ssavc4",
      code_symbol = "dynamic_vdw_runtime_rows_preserve_ssavc4_shader",
