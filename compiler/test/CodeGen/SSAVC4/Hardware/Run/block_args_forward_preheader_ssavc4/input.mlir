ssavc4.module @block_args_forward_preheader_ssavc4 {
  ssavc4.func @block_args_forward_preheader_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "block_args_forward_preheader_ssavc4",
      code_symbol = "block_args_forward_preheader_ssavc4_shader",
