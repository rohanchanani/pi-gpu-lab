ssavc4.module @dynamic_vdw_stride_13bit_boundary_ssavc4 {
  ssavc4.func @dynamic_vdw_stride_13bit_boundary_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_vdw_stride_13bit_boundary_ssavc4",
      code_symbol = "dynamic_vdw_stride_13bit_boundary_ssavc4_shader",
      tail_policy = "exact_multiple",
      uniform_words_per_qpu = 5 : i32,
      args = [
        {name = "in", kind = "buffer", direction = "in", elem_type = "u32", uniform_index = 0 : i32},
        {name = "out", kind = "buffer", direction = "out", elem_type = "u8", uniform_index = 1 : i32},
