ssavc4.module @vdr_vdw_vertical_32_roundtrip_ssavc4 {
  ssavc4.func @vdr_vdw_vertical_32_roundtrip_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "vdr_vdw_vertical_32_roundtrip_ssavc4",
      code_symbol = "vdr_vdw_vertical_32_roundtrip_ssavc4_shader",
