ssavc4.module @resource_independent_vdw_staging_rows_ssavc4 {
  ssavc4.func @resource_independent_vdw_staging_rows_ssavc4_kernel() attributes {
    kernel,
    ...
    "vc4.launch_abi" = {
      public_name = "resource_independent_vdw_staging_rows_ssavc4",
      code_symbol = "resource_independent_vdw_staging_rows_ssavc4_shader",
