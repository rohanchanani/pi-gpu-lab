ssavc4.module @resource_cooperative_vpm_rows_and_barrier_ssavc4 {
  ssavc4.func @resource_cooperative_vpm_rows_and_barrier_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "resource_cooperative_vpm_rows_and_barrier_ssavc4",
      code_symbol = "resource_cooperative_vpm_rows_and_barrier_ssavc4_shader",
...
args = [
    ...
    %read0 = ssavc4.vpm.read %vpm_row0 {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, x = 0 : i32, stride = 1 : i32, lanes = 16 : i32, orientation = #ssavc4.vpm_orientation<vertical>, serialize = "mutex"} : i32 -> vector<16xi32>
    ...
    %read1 = ssavc4.vpm.read %vpm_row1 {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, x = 0 : i32, stride = 1 : i32, lanes = 16 : i32, orientation = #ssavc4.vpm_orientation<vertical>, serialize = "mutex"} : i32 -> vector<16xi32>
    ...
    %read2 = ssavc4.vpm.read %vpm_row2 {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, x = 0 : i32, stride = 1 : i32, lanes = 16 : i32, orientation = #ssavc4.vpm_orientation<vertical>, serialize = "mutex"} : i32 -> vector<16xi32>
    ...
    %read3 = ssavc4.vpm.read %vpm_row3 {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, x = 0 : i32, stride = 1 : i32, lanes = 16 : i32, orientation = #ssavc4.vpm_orientation<vertical>, serialize = "mutex"} : i32 -> vector<16xi32>
