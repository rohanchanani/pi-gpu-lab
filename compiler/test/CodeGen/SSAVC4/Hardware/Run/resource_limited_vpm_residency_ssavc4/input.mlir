ssavc4.module @resource_limited_vpm_residency_ssavc4 {
  ssavc4.func @resource_limited_vpm_residency_ssavc4_kernel() attributes {
    kernel,
    ...
    "vc4.resource" = {
      ...
      compiler_vpm_staging_rows_per_warp = 17 : i32,
      compiler_vpm_staging_rows_per_block = 0 : i32,
      total_vpm_rows_per_block = 17 : i32,
      uses_tmu = false,
      uses_vpm = true,
    ...
    "vc4.launch_abi" = {
      public_name = "resource_limited_vpm_residency_ssavc4",
      code_symbol = "resource_limited_vpm_residency_ssavc4_shader",
