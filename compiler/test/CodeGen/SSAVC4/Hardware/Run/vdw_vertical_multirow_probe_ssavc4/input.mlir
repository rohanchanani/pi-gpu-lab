ssavc4.module @vdw_vertical_multirow_probe_ssavc4 {
  ssavc4.func @vdw_vertical_multirow_probe_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "vdw_vertical_multirow_probe_ssavc4",
      code_symbol = "vdw_vertical_multirow_probe_ssavc4_shader",
