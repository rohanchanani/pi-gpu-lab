ssavc4.module @dynamic_vdr_vdw_runtime_pitch_stride_rows_cols_ssavc4 {
  ssavc4.func @dynamic_vdr_vdw_runtime_pitch_stride_rows_cols_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_vdr_vdw_runtime_pitch_stride_rows_cols_ssavc4",
      code_symbol = "dynamic_vdr_vdw_runtime_pitch_stride_rows_cols_ssavc4_shader",
