ssavc4.module @f32_vector_loop_arg_forced_spill_ssavc4 {
  ssavc4.func @f32_vector_loop_arg_forced_spill_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "f32_vector_loop_arg_forced_spill_ssavc4",
      code_symbol = "f32_vector_loop_arg_forced_spill_ssavc4_shader",
