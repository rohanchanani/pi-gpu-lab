ssavc4.module @two_tmu_f32_loop_no_spill_ssavc4 {
  ssavc4.func @two_tmu_f32_loop_no_spill_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "two_tmu_f32_loop_no_spill_ssavc4",
      code_symbol = "two_tmu_f32_loop_no_spill_ssavc4_shader",
