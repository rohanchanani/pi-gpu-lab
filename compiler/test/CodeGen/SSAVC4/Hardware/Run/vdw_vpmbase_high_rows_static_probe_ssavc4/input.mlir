ssavc4.module @vdw_vpmbase_high_rows_static_probe_ssavc4 {
  ssavc4.func @vdw_vpmbase_high_rows_static_probe_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "vdw_vpmbase_high_rows_static_probe_ssavc4",
      code_symbol = "vdw_vpmbase_high_rows_static_probe_ssavc4_shader",
    ...
    %off4 = ssavc4.load_imm <splat32> {value = 4 : i32} : i32
    %off8 = ssavc4.load_imm <splat32> {value = 8 : i32} : i32
    %off12 = ssavc4.load_imm <splat32> {value = 12 : i32} : i32
    %off16 = ssavc4.load_imm <splat32> {value = 16 : i32} : i32
    %off20 = ssavc4.load_imm <splat32> {value = 20 : i32} : i32
    %off24 = ssavc4.load_imm <splat32> {value = 24 : i32} : i32
    %lane = ssavc4.element_number : vector<16xi32>
    %base0 = ssavc4.load_imm <splat32> {value = 2097152000 : i32} : vector<16xi32>
    %base1 = ssavc4.load_imm <splat32> {value = 2097152256 : i32} : vector<16xi32>
    %base2 = ssavc4.load_imm <splat32> {value = 2097152512 : i32} : vector<16xi32>
    %base3 = ssavc4.load_imm <splat32> {value = 2097152768 : i32} : vector<16xi32>
    %base4 = ssavc4.load_imm <splat32> {value = 2097153024 : i32} : vector<16xi32>
    %base5 = ssavc4.load_imm <splat32> {value = 2097153280 : i32} : vector<16xi32>
    %base6 = ssavc4.load_imm <splat32> {value = 2097153536 : i32} : vector<16xi32>
    %base7 = ssavc4.load_imm <splat32> {value = 2097153792 : i32} : vector<16xi32>
    %base8 = ssavc4.load_imm <splat32> {value = 2097154048 : i32} : vector<16xi32>
    %base9 = ssavc4.load_imm <splat32> {value = 2097154304 : i32} : vector<16xi32>
    %base10 = ssavc4.load_imm <splat32> {value = 2097154560 : i32} : vector<16xi32>
    %base11 = ssavc4.load_imm <splat32> {value = 2097154816 : i32} : vector<16xi32>
    %base12 = ssavc4.load_imm <splat32> {value = 2097155072 : i32} : vector<16xi32>
    %base13 = ssavc4.load_imm <splat32> {value = 2097155328 : i32} : vector<16xi32>
    %base14 = ssavc4.load_imm <splat32> {value = 2097155584 : i32} : vector<16xi32>
    %base15 = ssavc4.load_imm <splat32> {value = 2097155840 : i32} : vector<16xi32>
    ...
    ssavc4.vdw.store_vpm %out, %row0, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    %out1 = ssavc4.alu.add %out, %off4 {opcode = #vc4.add_opcode<add>} : (i32, i32) -> i32
    ssavc4.vdw.store_vpm %out1, %row1, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    %out2 = ssavc4.alu.add %out, %off8 {opcode = #vc4.add_opcode<add>} : (i32, i32) -> i32
    ssavc4.vdw.store_vpm %out2, %row2, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    %out3 = ssavc4.alu.add %out, %off12 {opcode = #vc4.add_opcode<add>} : (i32, i32) -> i32
    ssavc4.vdw.store_vpm %out3, %row12, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    %out4 = ssavc4.alu.add %out, %off16 {opcode = #vc4.add_opcode<add>} : (i32, i32) -> i32
    ssavc4.vdw.store_vpm %out4, %row13, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    %out5 = ssavc4.alu.add %out, %off20 {opcode = #vc4.add_opcode<add>} : (i32, i32) -> i32
    ssavc4.vdw.store_vpm %out5, %row14, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    %out6 = ssavc4.alu.add %out, %off24 {opcode = #vc4.add_opcode<add>} : (i32, i32) -> i32
    ssavc4.vdw.store_vpm %out6, %row15, %zero {width = #ssavc4.vpm_elem_width<w32>, subword = #ssavc4.vpm_subword<none>, row_len = 1 : i32, nrows = 1 : i32, memory_pitch_bytes = 4 : i32, active_lanes = 1 : i32, orientation = #ssavc4.vpm_orientation<horizontal>, serialize = "mutex"} : i32, i32, i32
    ssavc4.thread_end
  }
}
