ssavc4.module @gemm_shape_two_tmu_user_vdw_store_multiwave_ssavc4 {
  ssavc4.func @gemm_shape_two_tmu_user_vdw_store_multiwave_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "gemm_shape_two_tmu_user_vdw_store_multiwave_ssavc4",
      code_symbol = "gemm_shape_two_tmu_user_vdw_store_multiwave_ssavc4_shader",
