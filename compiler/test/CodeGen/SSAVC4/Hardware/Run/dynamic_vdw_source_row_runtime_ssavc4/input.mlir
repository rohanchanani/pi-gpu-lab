ssavc4.module @dynamic_vdw_source_row_runtime_ssavc4 {
  ssavc4.func @dynamic_vdw_source_row_runtime_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "dynamic_vdw_source_row_runtime_ssavc4",
      code_symbol = "dynamic_vdw_source_row_runtime_ssavc4_shader",
      ...
      args = [
        ...
        {name = "out", kind = "buffer", direction = "out", elem_type = "u32", uniform_index = 4 : i32},
        {name = "source_row", kind = "scalar", direction = "by_value", type = "u32", uniform_index = 5 : i32},
        {name = "active_cols", kind = "scalar", direction = "by_value", type = "u32", uniform_index = 6 : i32}
      ],
      builtins = []
    },
    "vc4.resource" = {
    ...
    %source_row = ssavc4.uniform.read 5 : i32
    %active_cols = ssavc4.uniform.read 6 : i32
    ...
    ssavc4.vdw.store_rect.dynamic %out, %source_row, %rows1, %active_cols, %stride {
      max_rows = 1 : i32,
      max_cols = 16 : i32,
      elem_bytes = 4 : i32,
      orientation = #ssavc4.vpm_orientation<horizontal>,
