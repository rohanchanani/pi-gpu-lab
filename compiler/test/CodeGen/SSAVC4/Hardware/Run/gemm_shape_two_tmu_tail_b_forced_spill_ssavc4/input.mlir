ssavc4.module @gemm_shape_two_tmu_tail_b_forced_spill_ssavc4 {
  ssavc4.func @gemm_shape_two_tmu_tail_b_forced_spill_ssavc4_kernel() attributes {
    kernel,
    threading = #vc4.threading_mode<single>,
    "vc4.launch_abi" = {
      public_name = "gemm_shape_two_tmu_tail_b_forced_spill_ssavc4",
      code_symbol = "gemm_shape_two_tmu_tail_b_forced_spill_ssavc4_shader",
      ...
      args = [
        ...
        {name = "active_cols", kind = "scalar", direction = "by_value", type = "u32", uniform_index = 5 : i32}
      ],
      builtins = [
    ...
    %active_cols = ssavc4.uniform.read 5 : i32
